...
let user_version = version + '(season ' + supported_diablo_season + ')';
const yaml_header_comment = ''
    + '# Generated by D4LF-editor version ' + user_version + '\n'
    + '# For D4LF version ' + supported_d4lf_version + '\n';
// Writing the version numbers to the web page
$('.version').text(user_version);
$('.supported-d4lf').text(supported_d4lf_version);
//endregion
//endregion
...
function convert_affix_filter_part_for_yaml(filter_object) {
    ...
    if (filter_object['affixes']['pool']['list'].length !== 0) {
        ...
        if (filter_object['affixes']['pool']['total_required'] !== 0) {
            affixPool['minCount'] = filter_object['affixes']['pool']['total_required'];
        }

        filter_for_yaml[filter_object['slot']]['affixPool'].push(affixPool);
    }
